...
MERGE (curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe:Claim {
    id: 'CLM:CURATED-2026-03-COPPER-CHINA-01-COPPER_WEAKENED_AS_CHINA_PROPERTY_ACTIVITY_SLOWE',
    claim_type: 'price_explanation',
    text: 'Copper weakened as China property activity slowed.',
    confidence: 0.74,
    source_id: 'DOC:CURATED-2026-03-COPPER-CHINA',
    start_time: datetime('2026-03-07T02:00:00Z')
  })
MERGE (curated_2026_03_copper_china_02_slower_chinese_construction_demand_reduced_deman:Claim {
    id: 'CLM:CURATED-2026-03-COPPER-CHINA-02-SLOWER_CHINESE_CONSTRUCTION_DEMAND_REDUCED_DEMAN',
    claim_type: 'demand_change',
    text: 'Slower Chinese construction demand reduced demand for copper.',
    confidence: 0.76,
    source_id: 'DOC:CURATED-2026-03-COPPER-CHINA',
    start_time: datetime('2026-03-07T02:00:00Z')
  })
MERGE (curated_2026_03_gold_macro_01_gold_gained_after_cpi_eased_and_real_yields_move:Claim {
    id: 'CLM:CURATED-2026-03-GOLD-MACRO-01-GOLD_GAINED_AFTER_CPI_EASED_AND_REAL_YIELDS_MOVE',
    claim_type: 'price_explanation',
    text: 'Gold gained after CPI eased and real yields moved lower.',
    confidence: 0.74,
    source_id: 'DOC:CURATED-2026-03-GOLD-MACRO',
    start_time: datetime('2026-03-11T13:00:00Z')
  })
MERGE (curated_2026_03_gold_macro_03_fed_guidance_remains_restrictive_but_markets_rea:Claim {
    id: 'CLM:CURATED-2026-03-GOLD-MACRO-03-FED_GUIDANCE_REMAINS_RESTRICTIVE_BUT_MARKETS_REA',
    claim_type: 'price_explanation',
    text: 'Fed guidance remains restrictive, but markets read the inflation data as reducing near-term yield pressure on gold.',
    confidence: 0.74,
    source_id: 'DOC:CURATED-2026-03-GOLD-MACRO',
    start_time: datetime('2026-03-11T13:00:00Z')
  })
MERGE (curated_2026_03_oil_supply_01_opec_maintained_supply_restraint_tightening_bren:Claim {
    id: 'CLM:CURATED-2026-03-OIL-SUPPLY-01-OPEC_MAINTAINED_SUPPLY_RESTRAINT_TIGHTENING_BREN',
    claim_type: 'supply_change',
    text: 'OPEC maintained supply restraint, tightening Brent availability.',
    confidence: 0.8,
    source_id: 'DOC:CURATED-2026-03-OIL-SUPPLY',
    start_time: datetime('2026-03-05T11:00:00Z')
  })
MERGE (curated_2026_03_oil_supply_02_red_sea_shipping_disruption_lifted_freight_stres:Claim {
    id: 'CLM:CURATED-2026-03-OIL-SUPPLY-02-RED_SEA_SHIPPING_DISRUPTION_LIFTED_FREIGHT_STRES',
    claim_type: 'shipment_delay',
    text: 'Red Sea shipping disruption lifted freight stress and delayed crude cargoes through the Suez Canal.',
    confidence: 0.77,
    source_id: 'DOC:CURATED-2026-03-OIL-SUPPLY',
    start_time: datetime('2026-03-05T11:00:00Z')
  })
MERGE (curated_2026_03_oil_supply_03_a_firmer_dollar_capped_some_upside_in_oil_even_a:Claim {
    id: 'CLM:CURATED-2026-03-OIL-SUPPLY-03-A_FIRMER_DOLLAR_CAPPED_SOME_UPSIDE_IN_OIL_EVEN_A',
    claim_type: 'price_explanation',
    text: 'A firmer dollar capped some upside in oil even as physical supply stayed tight.',
    confidence: 0.74,
    source_id: 'DOC:CURATED-2026-03-OIL-SUPPLY',
    start_time: datetime('2026-03-05T11:00:00Z')
  })
MERGE (curated_2026_03_silver_solar_01_solar_manufacturing_increased_demand_for_silver:Claim {
    id: 'CLM:CURATED-2026-03-SILVER-SOLAR-01-SOLAR_MANUFACTURING_INCREASED_DEMAND_FOR_SILVER',
    claim_type: 'demand_change',
    text: 'Solar manufacturing increased demand for silver.',
    confidence: 0.76,
    source_id: 'DOC:CURATED-2026-03-SILVER-SOLAR',
    start_time: datetime('2026-03-06T15:00:00Z')
  })
MERGE (curated_2026_03_silver_solar_02_silver_also_tracked_gold_higher_after_inflation:Claim {
    id: 'CLM:CURATED-2026-03-SILVER-SOLAR-02-SILVER_ALSO_TRACKED_GOLD_HIGHER_AFTER_INFLATION_',
    claim_type: 'price_explanation',
    text: 'Silver also tracked gold higher after inflation softened.',
    confidence: 0.74,
    source_id: 'DOC:CURATED-2026-03-SILVER-SOLAR',
    start_time: datetime('2026-03-06T15:00:00Z')
  })
...
MERGE (curated_2026_03_copper_china:Document {
    id: 'DOC:CURATED-2026-03-COPPER-CHINA',
    doc_type: 'note',
    title: 'China property weakness weighs on copper demand',
    publisher: 'Curated Metals Desk',
    published_at: datetime('2026-03-07T02:00:00Z'),
    url: 'internal://curated/2026-03-copper-china',
    summary: 'Curated note on China demand transmission into copper.'
  })
MERGE (curated_2026_03_gold_macro:Document {
    id: 'DOC:CURATED-2026-03-GOLD-MACRO',
    doc_type: 'note',
    title: 'Gold gains as CPI cools and real yields retreat',
    publisher: 'Curated Macro Desk',
    published_at: datetime('2026-03-11T13:00:00Z'),
    url: 'internal://curated/2026-03-gold-macro',
    summary: 'Curated note linking CPI, real yields, USD, and gold.'
  })
MERGE (curated_2026_03_oil_supply:Document {
    id: 'DOC:CURATED-2026-03-OIL-SUPPLY',
    doc_type: 'note',
    title: 'OPEC discipline and Red Sea delays tighten oil market',
    publisher: 'Curated Energy Desk',
    published_at: datetime('2026-03-05T11:00:00Z'),
    url: 'internal://curated/2026-03-oil-supply',
    summary: 'Curated note on oil supply and logistics.'
  })
MERGE (curated_2026_03_silver_solar:Document {
    id: 'DOC:CURATED-2026-03-SILVER-SOLAR',
    doc_type: 'note',
    title: 'Solar manufacturing continues to support silver usage',
    publisher: 'Curated Metals Desk',
    published_at: datetime('2026-03-06T15:00:00Z'),
    url: 'internal://curated/2026-03-silver-solar',
    summary: 'Curated note on silver\'s industrial demand channel.'
  })
...
MERGE (curated_2026_03_gold_macro)-[:SUPPORTS]->(curated_2026_03_gold_macro_01_gold_gained_after_cpi_eased_and_real_yields_move)
MERGE (curated_2026_03_gold_macro_01_gold_gained_after_cpi_eased_and_real_yields_move)-[:ABOUT]->(gold)
MERGE (curated_2026_03_gold_macro_01_gold_gained_after_cpi_eased_and_real_yields_move)-[:ABOUT]->(us_10y_real_yield)
MERGE (curated_2026_03_gold_macro_01_gold_gained_after_cpi_eased_and_real_yields_move)-[:ABOUT]->(us_cpi_yoy)
MERGE (curated_2026_03_gold_macro)-[:SUPPORTS]->(curated_2026_03_gold_macro_03_fed_guidance_remains_restrictive_but_markets_rea)
MERGE (curated_2026_03_gold_macro_03_fed_guidance_remains_restrictive_but_markets_rea)-[:ABOUT]->(gold)
MERGE (curated_2026_03_gold_macro_03_fed_guidance_remains_restrictive_but_markets_rea)-[:ABOUT]->(us_cpi_yoy)
MERGE (curated_2026_03_gold_macro_03_fed_guidance_remains_restrictive_but_markets_rea)-[:ABOUT]->(fed)
MERGE (curated_2026_03_oil_supply)-[:SUPPORTS]->(curated_2026_03_oil_supply_01_opec_maintained_supply_restraint_tightening_bren)
MERGE (curated_2026_03_oil_supply_01_opec_maintained_supply_restraint_tightening_bren)-[:ABOUT]->(oil_brent)
MERGE (curated_2026_03_oil_supply_01_opec_maintained_supply_restraint_tightening_bren)-[:ABOUT]->(opec)
MERGE (curated_2026_03_oil_supply)-[:SUPPORTS]->(curated_2026_03_oil_supply_02_red_sea_shipping_disruption_lifted_freight_stres)
MERGE (curated_2026_03_oil_supply_02_red_sea_shipping_disruption_lifted_freight_stres)-[:ABOUT]->(egy_suez_canal)
MERGE (curated_2026_03_oil_supply_02_red_sea_shipping_disruption_lifted_freight_stres)-[:ABOUT]->(oil_brent)
MERGE (curated_2026_03_oil_supply)-[:SUPPORTS]->(curated_2026_03_oil_supply_03_a_firmer_dollar_capped_some_upside_in_oil_even_a)
MERGE (curated_2026_03_oil_supply_03_a_firmer_dollar_capped_some_upside_in_oil_even_a)-[:ABOUT]->(oil_brent)
MERGE (curated_2026_03_oil_supply_03_a_firmer_dollar_capped_some_upside_in_oil_even_a)-[:ABOUT]->(dxy)
MERGE (curated_2026_03_copper_china)-[:SUPPORTS]->(curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe)
MERGE (curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe)-[:ABOUT]->(copper_cathode)
MERGE (curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe)-[:ABOUT]->(chn)
MERGE (curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe)-[:ABOUT]->(construction)
MERGE (curated_2026_03_copper_china_01_copper_weakened_as_china_property_activity_slowe)-[:ABOUT]->(chn_property_activity)
MERGE (curated_2026_03_copper_china)-[:SUPPORTS]->(curated_2026_03_copper_china_02_slower_chinese_construction_demand_reduced_deman)
MERGE (curated_2026_03_copper_china_02_slower_chinese_construction_demand_reduced_deman)-[:ABOUT]->(copper_cathode)
MERGE (curated_2026_03_copper_china_02_slower_chinese_construction_demand_reduced_deman)-[:ABOUT]->(chn)
MERGE (curated_2026_03_copper_china_02_slower_chinese_construction_demand_reduced_deman)-[:ABOUT]->(construction)
MERGE (curated_2026_03_silver_solar)-[:SUPPORTS]->(curated_2026_03_silver_solar_01_solar_manufacturing_increased_demand_for_silver)
MERGE (curated_2026_03_silver_solar_01_solar_manufacturing_increased_demand_for_silver)-[:ABOUT]->(silver)
MERGE (curated_2026_03_silver_solar_01_solar_manufacturing_increased_demand_for_silver)-[:ABOUT]->(solar)
MERGE (curated_2026_03_silver_solar)-[:SUPPORTS]->(curated_2026_03_silver_solar_02_silver_also_tracked_gold_higher_after_inflation)
MERGE (curated_2026_03_silver_solar_02_silver_also_tracked_gold_higher_after_inflation)-[:ABOUT]->(gold)
MERGE (curated_2026_03_silver_solar_02_silver_also_tracked_gold_higher_after_inflation)-[:ABOUT]->(silver)
MERGE (curated_2026_03_silver_solar_02_silver_also_tracked_gold_higher_after_inflation)-[:ABOUT]->(us_cpi_yoy);
